...
export class CoinbaseClient {
     ...
     */
    async listAccounts(paginateQuery?: PaginateQuery): Promise<PaginatedDataResponse<AccountResponse[]>> {
     ...
     */
    async listTransactions(accountId: string, paginateQuery?: PaginateQuery): Promise<PaginatedDataResponse<PaginatedTransactionResponse[]>> {
        return this.requestMaker.read<Promise<PaginatedDataResponse<any[]>>>(`/v2/accounts/${accountId}/transactions`, paginateQuery)
    }
    ...
    /*
        ...
        This endpoint requires the "wallet:addresses:read" permission.
     */
    async showTransaction(accountId: string, transactionId: string): Promise<DataResponse<TransactionResponse>> {
        return this.requestMaker.read<Promise<DataResponse<TransactionResponse>>>(`/v2/accounts/${accountId}/transactions/${transactionId}`)
    }
     ...
     */
    async sendMoney(accountId: string, to: string, amount: string, currency: string, options?: {
        idem?: string,
        ...
        if (options && options.toFinancialInstitution && !options.financialInstitutionWebsite) {
            throw new PayloadPreconditionFailedException('financialInstitutionWebsite is required when toFinancialInstitution is true');
        }
        ...
        if (options && options.toFinancialInstitution) {
            ...
            payload['financial_institution_website'] = options.financialInstitutionWebsite;
        }


        return this.requestMaker.create<Promise<DataResponse<TransactionResponse>>>(`/v2/accounts/${accountId}/transactions`, payload)
    }
     ...
     */
    async transferMoney(accountId: string, to: string, amount: string, currency: string, description?: string): Promise<DataResponse<TransactionResponse>> {
     ...
     */
    async listPaymentMethods(paginateQuery?: PaginateQuery): Promise<PaginatedDataResponse<PaginatedPaymentMethodResponse[]>> {
        return this.requestMaker.read<Promise<PaginatedDataResponse<PaginatedPaymentMethodResponse[]>>>(`/v2/payment-methods`, paginateQuery)
    }
    ...
    /*
        ...
        This endpoint requires the "wallet:payment-methods:read" permission.
     */
    async showPaymentMethod(paymentMethodId: string): Promise<DataResponse<PaymentMethodResponse>> {
        return this.requestMaker.read<Promise<DataResponse<PaymentMethodResponse>>>(`/v2/payment-methods/${paymentMethodId}`)
    }
    ...
    async getFiatCurrencies(): Promise<DataResponse<FiatCurrenciesResponse[]>> {
        return this.requestMaker.read<Promise<DataResponse<FiatCurrenciesResponse[]>>>(`/v2/currencies`)
    }
    ...
    async getCurrentTime(): Promise<DataResponse<TimeResponse>> {
        return this.requestMaker.read<Promise<DataResponse<TimeResponse>>>(`/v2/time`)
    }
    ...
    This endpoint does not require any permission.
     */
    async getBuyPrice(currencyPair: string): Promise<DataResponse<PriceResponse>> {
        validateCurrencyPair(currencyPair);
        return this.requestMaker.read<Promise<DataResponse<PriceResponse>>>(`/v2/prices/${currencyPair}/buy`)
    }
    ...
    /*
        ...
        This endpoint does not require any permission.
     */
    async getSellPrice(currencyPair: string): Promise<DataResponse<PriceResponse>> {
        validateCurrencyPair(currencyPair);
        return this.requestMaker.read<Promise<DataResponse<PriceResponse>>>(`/v2/prices/${currencyPair}/sell`)
    }
    ...
    /*
        ...
        This endpoint does not require any permission.
     */
    async getSpotPrice(currencyPair: string, date?: Date): Promise<DataResponse<PriceResponse>> {
        validateCurrencyPair(currencyPair);
     ...
     */
    async listBuys(paginateQuery?: PaginateQuery): Promise<PaginatedDataResponse<PaginatedBuyResponse[]>> {
        return this.requestMaker.read<Promise<PaginatedDataResponse<PaginatedBuyResponse[]>>>(`/v2/buys`, paginateQuery)
    }
    ...
    async showBuy(buyId: string): Promise<DataResponse<BuyResponse>> {
        return this.requestMaker.read<Promise<DataResponse<BuyResponse>>>(`/v2/buys/${buyId}`)
    }
     ...
     */
    async placeBuy(amount: string, currency: string, paymentMethodId: string, options?: {
        commit?: boolean
        quote?: string,
        ...
        return this.requestMaker.create<Promise<DataResponse<BuyResponse>>>(`/v2/buys`, payload)
    }
    ...
    async commitBuy(buyId: string): Promise<DataResponse<BuyResponse>> {
        return this.requestMaker.update<Promise<DataResponse<BuyResponse>>>(`/v2/buys/${buyId}/commit`, {})
    }
     ...
     */
    async listSells(paginateQuery?: PaginateQuery): Promise<PaginatedDataResponse<PaginatedSellResponse[]>> {
        return this.requestMaker.read<Promise<PaginatedDataResponse<PaginatedSellResponse[]>>>(`/v2/sells`, paginateQuery)
    }
    ...
    async showSell(sellId: string): Promise<DataResponse<SellResponse>> {
        return this.requestMaker.read<Promise<DataResponse<SellResponse>>>(`/v2/sells/${sellId}`)
    }
